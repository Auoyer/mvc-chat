...
public class PollingMannger
{
    ...
    /// 问题描述: http://blogs.msdn.com/b/tess/archive/2009/12/21/high-cpu-in-net-app-using-a-static-generic-dictionary.aspx
    /// </summary>
    //static Dictionary<int, PollingMannger> Online { get; set; }
